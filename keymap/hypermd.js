...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "codemirror", "codemirror", "../core"], factory);
    }
    else { //[HyperMD] UMD for plain environment!
      factory(function (m){
        if (m === "codemirror") return CodeMirror;
        if (m === "../core") return HyperMD;
      }, (this.HyperMD.KeyMap = this.HyperMD.KeyMap || {}));
    }
    ...
    exports.keyMap = {
        ...
        "Ctrl-B": createStyleToggler(function (state) { return state.strong; }, function (token) { return / formatting-strong /.test(token.type); }, function (state) { return core_1.repeatStr(state && state.strong || "*", 2); } // ** or __
        ),
