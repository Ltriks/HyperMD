...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "codemirror", "../core", "./fold"], factory);
    }
      ...
      }, (this.HyperMD.FoldMath = this.HyperMD.FoldMath || {}));
    }
    ...
    //#endregion
    fold_1.builtinFolder["math"] = exports.MathFolder; // inject fold's builtinFolders! Not cool but it works
    /********************************************************************************** */
