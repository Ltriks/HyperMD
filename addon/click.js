...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "codemirror", "../core", "../core", "./read-link"], factory);
    }
      ...
      }, (this.HyperMD.Click = this.HyperMD.Click || {}));
    }
    ...
    var read_link_1 = require("./read-link");
    //#endregion
    /********************************************************************************** */
    ...
    var Click = /** @class */ (function () {
        function Click(cm) {
            ...
            this._keyUp = function (ev) {
                ...
                /** FireFox */
                if (!className && _this._hadAlt && !ev.altKey) {
                    _this._hadAlt = false;
                    className = "HyperMD-with-alt";
                }
                if (className)
                    core_2.rmClass(_this.el, className);
            };
            ...
            this._keyDown = function (ev) {
                ...
                if (kc == 18)
                    _this._hadAlt = true;
                if (className)
                    core_2.addClass(_this.el, className);
            };
            /**
