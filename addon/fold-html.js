...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "codemirror", "../core", "./fold", "./read-link", "../core/utils"], factory);
    }
    else { //[HyperMD] UMD for plain environment!
      factory(function (m){
        if (m === "codemirror") return CodeMirror;
        if (m === "../core") return HyperMD;
        if (m === "./fold") return HyperMD.Fold;
        if (m === "./read-link") return HyperMD.ReadLink;
        if (m === "../core/utils") return HyperMD;
      }, (this.HyperMD.FoldHTML = this.HyperMD.FoldHTML || {}));
    }
    ...
    exports.defaultRenderer = function (html, pos, cm) {
        ...
        if ('innerHTML' in ans) {
            ...
            utils_1.visitElements([ans], function (el) {
    ...
    exports.HTMLFolder = function (stream, token) {
        ...
        if (!inlineMode) {
            ...
            while (allowCount > 0 && to.line < lastLine) {
                var nextLine = cm.getLine(to.line + 1);
                if (!/^\s*$/.test(nextLine))
                    break;
                to.line++;
    ...
    //#endregion
    fold_1.builtinFolder["html"] = exports.HTMLFolder; // inject fold's builtinFolders! Not cool but it works
